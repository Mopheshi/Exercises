package Week4; /******************************************************************************
 *  Compilation:  javac Week4.StdDraw.java
 *  Execution:    java Week4.StdDraw
 *  Dependencies: none
 *
...
/**
 * The {@code Week4.StdDraw} class provides static methods for creating drawings
 ...
 * <p>
 * <b>Getting started.</b>
 * To use this class, you must have {@code Week4.StdDraw.class} in your
 * Java classpath. If you used our autoinstaller, you should be all set.
 * Otherwise, either download
 * <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 * and add to your Java classpath or download
 * <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">Week4.StdDraw.java</a>
 ...
 *           Week4.StdDraw.setPenRadius(0.05);
 *           Week4.StdDraw.setPenColor(Week4.StdDraw.BLUE);
 *           Week4.StdDraw.point(0.5, 0.5);
 *           Week4.StdDraw.setPenColor(Week4.StdDraw.MAGENTA);
 *           Week4.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 * The methods {@code Week4.StdDraw.line()} and {@code Week4.StdDraw.point()}
 * draw lines and points; the methods {@code Week4.StdDraw.setPenRadius()}
 * and {@code Week4.StdDraw.setPenColor()} control the line thickness and color.
 * <p>
 ...
 * and represented in degrees. For example, {@code Week4.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  Week4.StdDraw.filledPolygon(x, y);
 * </pre>
 * p>
 * <b>Pen size.</b>
 ...
 * </ul>
 * p>
 * For example, {@code Week4.StdDraw.setPenRadius(0.01)} makes
 ...
 * For example, {@code Week4.StdDraw.setPenColor(Week4.StdDraw.MAGENTA)} sets the
 ...
 * For example, {@code Week4.StdDraw.setCanvasSize(800, 800)}
 ...
 * leave a small margin, you can call {@code Week4.StdDraw.setScale(-.05, 1.05)}.
 * p>
 ...
 *  Week4.StdDraw.setFont(font);
 *  Week4.StdDraw.text(0.5, 0.5, "Hello, World");
 * </pre>
 * p>
 * <b>Images.</b>
 ...
 *
 * <p><b>File formats.</b>
 * The {@code Week4.StdDraw} class supports reading and writing images to any of the
 ...
 * {@code Week4.StdDraw.clear(Week4.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 * of gray.
 * <p>
 * p>
 ...
 * <pre>
 *  Week4.StdDraw.setScale(-2.0, +2.0);
 *  Week4.StdDraw.enableDoubleBuffering();
 *
 *  for (double t = 0.0; true; t += 0.02) {
 *      double x = Math.sin(t);
 *      double y = Math.cos(t);
 *      Week4.StdDraw.clear();
 *      Week4.StdDraw.filledCircle(x, y, 0.1);
 *      Week4.StdDraw.filledCircle(-x, -y, 0.1);
 *      Week4.StdDraw.show();
 *      Week4.StdDraw.pause(20);
 *  }
 * </pre>
...
*/
     ...
     * {@code Week4.StdDraw.BLACK}, {@code Week4.StdDraw.BLUE}, {@code Week4.StdDraw.CYAN},
     * {@code Week4.StdDraw.DARK_GRAY}, {@code Week4.StdDraw.GRAY}, {@code Week4.StdDraw.GREEN},
     * {@code Week4.StdDraw.LIGHT_GRAY}, {@code Week4.StdDraw.MAGENTA}, {@code Week4.StdDraw.ORANGE},
     * {@code Week4.StdDraw.PINK}, {@code Week4.StdDraw.RED}, {@code Week4.StdDraw.WHITE}, and
     * {@code Week4.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Week4.StdDraw)
        if (icon.getImageLoadStatus() != MediaTracker.COMPLETE) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Week4.StdDraw)
        try {
            URL url = Week4.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
